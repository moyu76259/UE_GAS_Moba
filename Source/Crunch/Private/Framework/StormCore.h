...
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnGoalReachedDelegate, AActor* /*ViewTarget*/, int/*Wining Team*/);
...
public:
	...
	FOnTeamInfluencerCountUpdatedDelegate OnTeamInfluenceCountUpdated;
...
private:
	...
	UFUNCTION()
	void NewInfluencerInRange(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,UPrimitiveComponent* OtherComp,
