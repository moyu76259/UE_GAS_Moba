...
void UCAbilitySystemComponent::Server_UpgradeAbilityWithID_Implementation(ECAbilityInputID InputID)
{
	...
	Client_AbilitySpecLevelUpgraded(AbilitySpec->Handle, AbilitySpec->Level);
}
...
void UCAbilitySystemComponent::Client_AbilitySpecLevelUpgraded_Implementation(FGameplayAbilitySpecHandle Handle,
	int NewLevel)
{
